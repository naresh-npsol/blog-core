...
class StatusView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context = {
            "title": "Status | smartblog.app",
            "description": "Track the uptime and performance of smartblog.app in real-time. Stay informed of any issues that may affect your browsing experience.",
            "status": blog_status,
...
class AllPostsView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context["title"] = "All Posts | smartposter.app"
        context["description"] = "All posts on smartposter.app"
        return context
...
class HomeView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super().get_context_data(*args, **kwargs)
        context["url"] = self.request.path
        context["title"] = "Smartposter Blog | smartposter.app"
...
class CategoryView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context["url"] = self.request.path
        context["title"] = f"{category.name.title()} | smartposter.app"
        context[
            "description"
